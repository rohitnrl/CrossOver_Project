...
namespace CrossExchange_Project.Migrations
{
    ...
    [Migration("20180930073100_InitialCreate1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrossExchange_Project.HourlyShareRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CrossExchange_Project.Portfolio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CrossExchange_Project.Trade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CrossExchange_Project.Trade", b =>
                {
                    b.HasOne("CrossExchange_Project.Portfolio")
                        .WithMany("Trade")
